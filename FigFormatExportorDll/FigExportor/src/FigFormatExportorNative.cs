...
namespace FigExportorNative
{
  /// <summary>
  /// The FigFormatExportor class provides a CLS compliant, Object (native) interface to
  ...
  public class FigFormatExportor : IDisposable
  {
    ...
    /// <summary>
    /// Provides a void output, 0-input Objectinterface to the SaveFig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ///
    public void SaveFig()
    {
      mcr.EvaluateFunction(0, "SaveFig", new Object[]{});
    }


    /// <summary>
    /// Provides a void output, 1-input Objectinterface to the SaveFig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="targetfn">Input argument #1</param>
    ///
    public void SaveFig(Object targetfn)
    {
    ...
    /// <summary>
    /// Provides the standard 0-input Object interface to the SaveFig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    ...
    /// arguments.</returns>
    ///
    public Object[] SaveFig(int numArgsOut)
    {
      return mcr.EvaluateFunction(numArgsOut, "SaveFig", new Object[]{});
    }


    /// <summary>
    /// Provides the standard 1-input Object interface to the SaveFig M-function.
    /// </summary>
    /// <remarks>
    /// </remarks>
    /// <param name="numArgsOut">The number of output arguments to return.</param>
    ...
    /// arguments.</returns>
    ///
    public Object[] SaveFig(int numArgsOut, Object targetfn)
    {
